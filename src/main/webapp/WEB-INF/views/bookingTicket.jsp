...
<head>
    ...
    <jsp:include page="./layout-view/head_libraries.jsp"/>
                                ...
                                <li class="time-li">
                                    ...
                                    <div class="time-btn">
                                        <c:forEach items="<%= value %>" var="time">
                                            <a href="bookingTicket?action=changeToSeatBooking&time=${time}&cinemaRoomName=<%=key%>&date=${localDate}&cinemaName=${cinemaName}&movieID=${movieID}" style="border-radius: 5px; background-color: #0f6674; padding: 10px ;color: white;margin: 10px 5px">${time}</a>
                                        </c:forEach>
                                    </div>
                                    <%    } %>
                                    <% } %>
...
<%-- Footer --%>
<jsp:include page="layout-view/footer.jsp"/>
<jsp:include page="layout-view/script-libraries.jsp" />
<jsp:include page="layout-view/js-function-slider.jsp" />
<jsp:include page="layout-view/script_bookingTicket.jsp" />
<!-- responsive tabs -->
