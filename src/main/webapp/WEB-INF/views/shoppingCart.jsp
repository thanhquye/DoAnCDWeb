        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered m-0">
                    ...
                    <tbody>
                    <c:forEach items="${cartDTOS}" var="cart">
                        <tr>
                            <td class="p-4">
                                <div class="media align-items-center">
                                    <img src="${pageContext.request.contextPath}/assets/movie-image/${cart.image}" class="d-block ui-w-40 ui-bordered mr-4" alt="">
                                    <div class="media-body">
                                        <a href="#" class="d-block text-dark">${cart.movieName}</a>
                                        <small>
                                            <span class="text-muted">ngày: </span> ${cart.date}
                                            <span class="text-muted">ghế: </span> ${cart.seatName}
                                            <span class="text-muted">thời gian </span> ${cart.time}
                                        </small>
                                    </div>
                                </div>
                            </td>
                            <td class="text-right font-weight-semibold align-middle p-4">${cart.moviePrice}</td>
