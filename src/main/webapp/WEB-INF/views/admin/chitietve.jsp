<%@ page import="com.example.Movie_Ticket_Website.model.TicketDetail" %>
<%@ page import="com.example.Movie_Ticket_Website.dto.TicketWithMovieDTO" %>
    ...
    <!-- HEADER DESKTOP-->
        ...
        <div class="main-content">
            <div>
                <div class="card">
                    <div class="card-body">
                        <% TicketWithMovieDTO ticketDetail = (TicketWithMovieDTO) request.getAttribute("ticketDetail");%>
