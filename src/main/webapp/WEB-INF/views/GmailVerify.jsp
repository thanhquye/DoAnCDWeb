...
<div class="w3l-breadcrumbs">
    <nav id="breadcrumbs" class="breadcrumbs">
        <div class="container page-wrapper">
            <a href="/">Home</a> » <span class="breadcrumb_last" aria-current="page">Xác Thực Gmail</span>
        </div>
    </nav>
</div>
...
<script src="${pageContext.request.contextPath}/assets/js/gmailVerify.js"></script>
