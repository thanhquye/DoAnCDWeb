...
<body>
    ...
    <div class="w3l-breadcrumbs">
        <nav id="breadcrumbs" class="breadcrumbs">
            <div class="container page-wrapper">
                <a href="/">Home</a> » <span class="breadcrumb_last" aria-current="page">Thông Tin</span>
            </div>
        </nav>
    </div>
        ...
        <div class="container py-lg-4">
            <div class="row ab-grids-sec align-items-center">
                ...
                <div class="col-lg-6 ab-right">
                    <img class="img-fluid" src="${pageContext.request.contextPath}assets/images/obitoAVATAR.png">
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <img class="rounded-circle shadow-1-strong mb-4"
                                 src="${pageContext.request.contextPath}assets/images/thanh_quyen_avt.png" alt="avatar"
                                 style="width: 150px;" />
                        ...
                        <div class="col-lg-4 d-none d-lg-block">
                            <img class="rounded-circle shadow-1-strong mb-4"
                                 src="${pageContext.request.contextPath}assets/images/thanh_phat_avt.png" alt="avatar"
                                 style="width: 150px;" />
    ...
    <!--/theme-change-->
    <script src="a${pageContext.request.contextPath}ssets/js/theme-change.js"></script>
